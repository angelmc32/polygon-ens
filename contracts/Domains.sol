...
contract Domains is ERC721URIStorage {
  ...
  constructor(string memory _tld) ERC721("Gorduki Name Service", "GNS") payable {
  ...
  function register(string calldata name) public payable {
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        '{"name": "',
        _name,
        '", "description": "A domain on the Gorduki name service", "image": "data:image/svg+xml;base64,',
